...
$(document).ready(function () {
  ...
  $.getJSON('./assets/js/news.json', function (data) {
    var ul = $('<ul></ul>').attr('id', 'kart_news');
    data.forEach(function (newsItem) {
      var li = $('<li></li>');
      var a = $('<a></a>').attr('href', newsItem.link).attr('target', '_blank');
      var img = $('<img>').attr('src', newsItem.image).attr('alt', 'news foto').addClass('building_img');
      var newsContent = $('<div></div>').addClass('news_content');
      var newsH = $('<p></p>').text(newsItem.title).addClass('news_h');
      var newDesc = $('<p></p>').text(newsItem.description).addClass('new_desc');
      var personCart = $('<div></div>').addClass('person_cart');
      var imgFoto = $('<img>').attr('src', newsItem.autor.foto).attr('alt', 'foto').addClass('person_foto');
      var div = $('<div></div>');
      var nameFoto = $('<p></p>').text(newsItem.autor.name).addClass('name_foto');
      var time = $('<time></time>').text(newsItem.autor.time);
  ...
  var scrollBtn = $('.scroll_whatwedo a');
